...
export default function OccupantCell({occupant, onSelect, selected}: OccupantCellProps) {
    return (
        <TableRow>
            <TableCell>
                <Checkbox checked={selected} onChange={(e, checked) => onSelect(checked, occupant.id)} />
            </TableCell>
            <TableCell>
                <img
